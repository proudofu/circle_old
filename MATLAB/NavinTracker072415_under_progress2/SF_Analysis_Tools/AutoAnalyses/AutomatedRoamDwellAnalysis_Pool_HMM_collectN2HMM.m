function [dwellStateDurations roamStateDurations FractionDwelling FractionRoaming TrackInfo N2_TR N2_E] = AutomatedRoamDwellAnalysis_Pool_HMM_collectN2HMM(folder,Date,Genotype)
    ...
    for(i = 3:NumFolders)
        ...
        [ReversalInfo] = getAllRevs_HMM_longSpeed(folder);
