...
%     while(answer(1) ~= 'N')
        ...
        while(answer(1) == 'N')
            ...
            answer = questdlg('Do these points look right? Hit "No" to try again.', sprintf('Keep up the good work.'), 'Yes', 'No', 'Yes');
            hold off;
        end
        close all
...
%         end
        ...
        answer = questdlg('Does this ring look right? Hit "No" to try again.', sprintf("Good hustle, champ."), 'Yes', 'No', 'Yes');
        if(answer(1)=='Y')
            answer='No';
        else
            answer='Yes';
