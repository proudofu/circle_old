function [dsd1_InclEnds rsd1_InclEnds dsd2_InclEnds rsd2_InclEnds] = compareTwoGenotypes_HMM_useN2HMM(folderWithBoth,Date)
    % folderwithBoth should contain two folders and within each of these
    % folders, each video file (and finalTracks file) should be within its
    % own folder (name of each video-containing folder is irrelevant, but
    % name of genotype folders is relevant: name should be: 1_n2, 2_mutant
