function finalTracks = processTracks_OFFFOOD (folder) % Folder should have all files for one video
...
Prefs.MaxCentroidShift_mm_per_sec =.3;
...
index_less_than_5min = find(tracks_length<180);
